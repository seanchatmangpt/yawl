#!/usr/bin/env bash
# ==========================================================================
# emit-yawl-xml.sh — Generates the YAWL XML build-and-test workflow net
#
# Produces: diagrams/yawl/build-and-test.yawl.xml
# Models the Maven build/test lifecycle as a YAWL workflow specification.
# ==========================================================================
...
YAWL_HEADER
    ...
    # Insert run_id as a comment
    printf '  Run ID: %s\n' "$run_id" >> "$out"
    printf '  Receipt: docs/v6/latest/receipts/observatory.json\n' >> "$out"
    printf '  Generated by: scripts/observatory/observatory.sh\n' >> "$out"
...
emit_yawl_xml_all() {
    ...
    log_ok "YAWL XML emitted in ${YAWL_XML_ELAPSED}ms"
}
