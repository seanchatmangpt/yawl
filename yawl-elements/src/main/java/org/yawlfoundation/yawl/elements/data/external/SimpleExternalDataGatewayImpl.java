...
// import org.yawlfoundation.yawl.integration.CredentialManager; // Optional dependency
...
public class SimpleExternalDataGatewayImpl implements ExternalDataGateway {
    ...
    public boolean configure() {
        if (! configured) {
            String jdbcUrl = System.getenv("YAWL_JDBC_URL");
            if (jdbcUrl == null) {
                ...
                if (host != null && port != null && name != null) {
                    ...
                    throw new IllegalStateException("Missing database connection environment variables");
                }
            }

            String user = System.getenv("YAWL_JDBC_USER");
            if (user == null) {
            ...
            String password = System.getenv("YAWL_JDBC_PASSWORD");
            if (password == null) {
                password = System.getenv("DB_PASSWORD");
            }
            if (password == null) {
                throw new IllegalStateException("Missing database password environment variable");
            }
