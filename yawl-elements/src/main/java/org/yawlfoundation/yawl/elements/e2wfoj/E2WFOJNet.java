...
/**
 * Stateful-engine thin wrapper around {@link E2WFOJCore}.
 *
 ...
 * <ul>
 *   <li>Adapts the stateful {@code YNet} to the {@code INetElementProvider} interface
 *       by passing a method reference ({@code yNet::getNetElements}).</li>
 *   <li>Accepts the stateful {@code YTask} for the OR-join (which implements
...
public final class E2WFOJNet {
    ...
    /**
     * Constructs a Reset net from a stateful YAWL net for OR-join analysis.
     *
