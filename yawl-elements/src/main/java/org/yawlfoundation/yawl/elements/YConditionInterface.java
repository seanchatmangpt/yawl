...
public interface YConditionInterface {
     ...
     */
    YIdentifier removeOne() throws RuntimeException, YPersistenceException;
     ...
     * @throws YPersistenceException if there's a problem persisting the change.
     */
    void removeOne(YIdentifier identifier) throws YPersistenceException;
     ...
     * @throws YPersistenceException if there's a problem persisting the change.
     */
    void remove(YIdentifier identifier, int amount) throws YStateException, YPersistenceException;
     ...
     * @throws YPersistenceException if there's a problem persisting the change.
     */
    void removeAll(YIdentifier identifier) throws YPersistenceException;

    /**
     * Remove all the identifiers in the condition.
     * @throws YPersistenceException if there's a problem persisting the change.
     */
    void removeAll() throws YPersistenceException;

    /**
     * Remove all the identifiers in the condition with persistence manager.
     ...
     * @throws YPersistenceException if there's a problem persisting the change.
     */
    void add(YIdentifier id) throws YPersistenceException;

    /**
     * Add an identifier to the condition with persistence manager.
     * @param pmgr the persistence manager
     * @param id the identifier to add
     * @throws YPersistenceException if there's a problem persisting the change.
     */
    ...
    /**
     * Remove one identifier from the condition with persistence manager.
     * @param pmgr the persistence manager
     * @throws YPersistenceException if there's a problem persisting the change.
     */
    void removeOne(YPersistenceManager pmgr) throws YPersistenceException;
