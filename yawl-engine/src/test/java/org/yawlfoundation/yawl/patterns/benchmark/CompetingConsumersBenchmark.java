...
public class CompetingConsumersBenchmark extends BenchmarkBase {
    ...
    @Benchmark
    @Param({"4", "8", "16", "32"})
    public void workDistributionFairness(int workerCount, Blackhole bh) throws Exception {
    ...
    @Benchmark
    @Param({"1", "2", "4", "8", "16", "32"})
    public void throughputVsWorkers(int workerCount, Blackhole bh) throws Exception {
