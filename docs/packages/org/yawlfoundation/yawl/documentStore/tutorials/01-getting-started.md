# yawl.documentStore Package Tutorial

**Audience**: Developers new to the yawl.documentStore package
**Time**: ~15 minutes
...
- Understand the purpose of the yawl.documentStore package
...
import org.yawlfoundation.yawl.documentStore.*;
```
