# tooling.schema Package Tutorial

**Audience**: Developers new to the tooling.schema package
**Time**: ~15 minutes
...
- Understand the purpose of the tooling.schema package
...
import org.yawlfoundation.yawl.tooling.schema.*;
```
...
*Package: `org.yawlfoundation.yawl.tooling.schema`*
*Since: 6.0.0*
