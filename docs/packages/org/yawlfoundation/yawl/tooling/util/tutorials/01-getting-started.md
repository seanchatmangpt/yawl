# tooling.util Package Tutorial

**Audience**: Developers new to the tooling.util package
**Time**: ~15 minutes
...
- Understand the purpose of the tooling.util package
...
import org.yawlfoundation.yawl.tooling.util.*;
```
...
*Package: `org.yawlfoundation.yawl.tooling.util`*
*Since: 6.0.0*
