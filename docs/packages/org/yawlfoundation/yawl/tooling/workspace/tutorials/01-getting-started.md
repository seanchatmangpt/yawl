# tooling.workspace Package Tutorial

**Audience**: Developers new to the tooling.workspace package
**Time**: ~15 minutes
...
- Understand the purpose of the tooling.workspace package
...
import org.yawlfoundation.yawl.tooling.workspace.*;
```
...
*Package: `org.yawlfoundation.yawl.tooling.workspace`*
*Since: 6.0.0*
