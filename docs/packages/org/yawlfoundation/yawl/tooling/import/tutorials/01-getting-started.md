# tooling.import Package Tutorial

**Audience**: Developers new to the tooling.import package
**Time**: ~15 minutes
...
- Understand the purpose of the tooling.import package
...
import org.yawlfoundation.yawl.tooling.import.*;
```
