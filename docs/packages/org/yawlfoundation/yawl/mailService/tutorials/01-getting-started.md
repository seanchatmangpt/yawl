# yawl.mailService Package Tutorial

**Audience**: Developers new to the yawl.mailService package
**Time**: ~15 minutes
...
- Understand the purpose of the yawl.mailService package
...
import org.yawlfoundation.yawl.mailService.*;
```
