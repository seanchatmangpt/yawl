# data.external Package Tutorial

**Audience**: Developers new to the data.external package
**Time**: ~15 minutes
...
- Understand the purpose of the data.external package
...
import org.yawlfoundation.yawl.stateless.elements.data.external.*;
```
