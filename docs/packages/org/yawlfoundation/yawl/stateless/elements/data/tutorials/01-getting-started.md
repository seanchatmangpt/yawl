# elements.data Package Tutorial

**Audience**: Developers new to the elements.data package
**Time**: ~15 minutes
...
- Understand the purpose of the elements.data package
...
import org.yawlfoundation.yawl.stateless.elements.data.*;
```
