# elements.marking Package Tutorial

**Audience**: Developers new to the elements.marking package
**Time**: ~15 minutes
...
- Understand the purpose of the elements.marking package
...
import org.yawlfoundation.yawl.stateless.elements.marking.*;
```
