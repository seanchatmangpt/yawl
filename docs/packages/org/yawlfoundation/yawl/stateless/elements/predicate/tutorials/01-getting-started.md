# elements.predicate Package Tutorial

**Audience**: Developers new to the elements.predicate package
**Time**: ~15 minutes
...
- Understand the purpose of the elements.predicate package
...
import org.yawlfoundation.yawl.stateless.elements.predicate.*;
```
