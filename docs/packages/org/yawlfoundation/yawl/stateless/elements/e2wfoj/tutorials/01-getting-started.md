# elements.e2wfoj Package Tutorial

**Audience**: Developers new to the elements.e2wfoj package
**Time**: ~15 minutes
...
- Understand the purpose of the elements.e2wfoj package
...
import org.yawlfoundation.yawl.stateless.elements.e2wfoj.*;
```
