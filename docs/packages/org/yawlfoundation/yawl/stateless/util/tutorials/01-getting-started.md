# stateless.util Package Tutorial

**Audience**: Developers new to the stateless.util package
**Time**: ~15 minutes
...
- Understand the purpose of the stateless.util package
...
import org.yawlfoundation.yawl.stateless.util.*;
```
