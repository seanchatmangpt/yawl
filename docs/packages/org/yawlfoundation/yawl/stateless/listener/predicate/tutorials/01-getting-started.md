# listener.predicate Package Tutorial

**Audience**: Developers new to the listener.predicate package
**Time**: ~15 minutes
...
- Understand the purpose of the listener.predicate package
...
import org.yawlfoundation.yawl.stateless.listener.predicate.*;
```
