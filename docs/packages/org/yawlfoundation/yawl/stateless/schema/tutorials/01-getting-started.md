# stateless.schema Package Tutorial

**Audience**: Developers new to the stateless.schema package
**Time**: ~15 minutes
...
- Understand the purpose of the stateless.schema package
...
import org.yawlfoundation.yawl.stateless.schema.*;
```
