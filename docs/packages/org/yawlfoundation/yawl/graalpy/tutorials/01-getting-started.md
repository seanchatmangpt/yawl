# yawl.graalpy Package Tutorial

**Audience**: Developers new to the yawl.graalpy package
**Time**: ~15 minutes
...
- Understand the purpose of the yawl.graalpy package
...
import org.yawlfoundation.yawl.graalpy.*;
```
