# yawl.swingWorklist Package Tutorial

**Audience**: Developers new to the yawl.swingWorklist package
**Time**: ~15 minutes
...
- Understand the purpose of the yawl.swingWorklist package
...
import org.yawlfoundation.yawl.swingWorklist.*;
```
