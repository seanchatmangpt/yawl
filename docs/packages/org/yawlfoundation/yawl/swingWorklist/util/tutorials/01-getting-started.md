# swingWorklist.util Package Tutorial

**Audience**: Developers new to the swingWorklist.util package
**Time**: ~15 minutes
...
- Understand the purpose of the swingWorklist.util package
...
import org.yawlfoundation.yawl.swingWorklist.util.*;
```
