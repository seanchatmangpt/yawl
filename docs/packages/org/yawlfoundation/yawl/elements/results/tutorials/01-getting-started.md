# elements.results Package Tutorial

**Audience**: Developers new to the elements.results package
**Time**: ~15 minutes
...
- Understand the purpose of the elements.results package
...
import org.yawlfoundation.yawl.elements.results.*;
```
