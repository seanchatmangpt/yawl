# marketplace.resources Package Tutorial

**Audience**: Developers new to the marketplace.resources package
**Time**: ~15 minutes
...
- Understand the purpose of the marketplace.resources package
...
import org.yawlfoundation.yawl.elements.marketplace.resources.*;
```
