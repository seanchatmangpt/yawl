# marketplace.conditions Package Tutorial

**Audience**: Developers new to the marketplace.conditions package
**Time**: ~15 minutes
...
- Understand the purpose of the marketplace.conditions package
...
import org.yawlfoundation.yawl.elements.marketplace.conditions.*;
```
