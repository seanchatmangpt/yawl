# engine.receipts Package Tutorial

**Audience**: Developers new to the engine.receipts package
**Time**: ~15 minutes
...
- Understand the purpose of the engine.receipts package
...
import org.yawlfoundation.yawl.engine.receipts.*;
```
