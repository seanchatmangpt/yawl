# engine.gui Package Tutorial

**Audience**: Developers new to the engine.gui package
**Time**: ~15 minutes
...
- Understand the purpose of the engine.gui package
...
import org.yawlfoundation.yawl.engine.gui.*;
```
