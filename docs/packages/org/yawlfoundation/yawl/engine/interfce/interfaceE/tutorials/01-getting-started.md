# interfce.interfaceE Package Tutorial

**Audience**: Developers new to the interfce.interfaceE package
**Time**: ~15 minutes
...
- Understand the purpose of the interfce.interfaceE package
...
import org.yawlfoundation.yawl.engine.interfce.interfaceE.*;
```
