# interfce.rest Package Tutorial

**Audience**: Developers new to the interfce.rest package
**Time**: ~15 minutes
...
- Understand the purpose of the interfce.rest package
...
import org.yawlfoundation.yawl.engine.interfce.rest.*;
```
