# interfce.interfaceB Package Tutorial

**Audience**: Developers new to the interfce.interfaceB package
**Time**: ~15 minutes
...
- Understand the purpose of the interfce.interfaceB package
