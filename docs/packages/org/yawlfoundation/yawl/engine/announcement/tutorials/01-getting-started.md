# engine.announcement Package Tutorial

**Audience**: Developers new to the engine.announcement package
**Time**: ~15 minutes
...
- Understand the purpose of the engine.announcement package
