# time.workdays Package Tutorial

**Audience**: Developers new to the time.workdays package
**Time**: ~15 minutes
...
- Understand the purpose of the time.workdays package
...
import org.yawlfoundation.yawl.engine.time.workdays.*;
```
