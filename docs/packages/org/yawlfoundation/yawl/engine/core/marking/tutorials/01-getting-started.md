# core.marking Package Tutorial

**Audience**: Developers new to the core.marking package
**Time**: ~15 minutes
...
- Understand the purpose of the core.marking package
...
import org.yawlfoundation.yawl.engine.core.marking.*;
```
