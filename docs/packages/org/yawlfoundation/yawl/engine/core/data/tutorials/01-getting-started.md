# core.data Package Tutorial

**Audience**: Developers new to the core.data package
**Time**: ~15 minutes
...
- Understand the purpose of the core.data package
...
import org.yawlfoundation.yawl.engine.core.data.*;
```
