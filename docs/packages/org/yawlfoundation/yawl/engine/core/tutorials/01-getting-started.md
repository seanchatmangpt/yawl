# engine.core Package Tutorial

**Audience**: Developers new to the engine.core package
**Time**: ~15 minutes
...
- Understand the purpose of the engine.core package
...
import org.yawlfoundation.yawl.engine.core.*;
```
