# core.predicate Package Tutorial

**Audience**: Developers new to the core.predicate package
**Time**: ~15 minutes
...
- Understand the purpose of the core.predicate package
...
import org.yawlfoundation.yawl.engine.core.predicate.*;
```
