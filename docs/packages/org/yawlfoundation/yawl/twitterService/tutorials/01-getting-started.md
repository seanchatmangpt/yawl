# yawl.twitterService Package Tutorial

**Audience**: Developers new to the yawl.twitterService package
**Time**: ~15 minutes
...
- Understand the purpose of the yawl.twitterService package
...
import org.yawlfoundation.yawl.twitterService.*;
```
