# yawl.smsModule Package Tutorial

**Audience**: Developers new to the yawl.smsModule package
**Time**: ~15 minutes
...
- Understand the purpose of the yawl.smsModule package
...
import org.yawlfoundation.yawl.smsModule.*;
```
