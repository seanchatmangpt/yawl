# yawl.wsif Package Tutorial

**Audience**: Developers new to the yawl.wsif package
**Time**: ~15 minutes
...
- Understand the purpose of the yawl.wsif package
...
import org.yawlfoundation.yawl.wsif.*;
```
