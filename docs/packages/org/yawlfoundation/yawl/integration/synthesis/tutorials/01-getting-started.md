# integration.synthesis Package Tutorial

**Audience**: Developers new to the integration.synthesis package
**Time**: ~15 minutes
...
- Understand the purpose of the integration.synthesis package
...
import org.yawlfoundation.yawl.integration.synthesis.*;
```
