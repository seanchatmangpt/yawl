# a2a.resilience Package Tutorial

**Audience**: Developers new to the a2a.resilience package
**Time**: ~15 minutes
...
- Understand the purpose of the a2a.resilience package
...
import org.yawlfoundation.yawl.integration.a2a.resilience.*;
```
