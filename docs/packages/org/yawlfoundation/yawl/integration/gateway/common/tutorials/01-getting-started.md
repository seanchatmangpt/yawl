# gateway.common Package Tutorial

**Audience**: Developers new to the gateway.common package
**Time**: ~15 minutes
...
- Understand the purpose of the gateway.common package
...
import org.yawlfoundation.yawl.integration.gateway.common.*;
```
