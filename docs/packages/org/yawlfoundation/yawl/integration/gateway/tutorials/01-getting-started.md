# integration.gateway Package Tutorial

**Audience**: Developers new to the integration.gateway package
**Time**: ~15 minutes
...
- Understand the purpose of the integration.gateway package
...
import org.yawlfoundation.yawl.integration.gateway.*;
```
