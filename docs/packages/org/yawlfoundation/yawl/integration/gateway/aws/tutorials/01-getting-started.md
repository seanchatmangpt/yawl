# gateway.aws Package Tutorial

**Audience**: Developers new to the gateway.aws package
**Time**: ~15 minutes
...
- Understand the purpose of the gateway.aws package
...
import org.yawlfoundation.yawl.integration.gateway.aws.*;
```
