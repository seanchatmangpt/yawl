# gateway.kong Package Tutorial

**Audience**: Developers new to the gateway.kong package
**Time**: ~15 minutes
...
- Understand the purpose of the gateway.kong package
...
import org.yawlfoundation.yawl.integration.gateway.kong.*;
```
