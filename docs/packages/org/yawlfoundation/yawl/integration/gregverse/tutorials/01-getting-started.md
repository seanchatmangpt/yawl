# integration.gregverse Package Tutorial

**Audience**: Developers new to the integration.gregverse package
**Time**: ~15 minutes
...
- Understand the purpose of the integration.gregverse package
...
import org.yawlfoundation.yawl.integration.gregverse.*;
```
