# wizard.core Package Tutorial

**Audience**: Developers new to the wizard.core package
**Time**: ~15 minutes
...
- Understand the purpose of the wizard.core package
...
import org.yawlfoundation.yawl.integration.wizard.core.*;
```
