# wizard.mcp Package Tutorial

**Audience**: Developers new to the wizard.mcp package
**Time**: ~15 minutes
...
- Understand the purpose of the wizard.mcp package
...
import org.yawlfoundation.yawl.integration.wizard.mcp.*;
```
