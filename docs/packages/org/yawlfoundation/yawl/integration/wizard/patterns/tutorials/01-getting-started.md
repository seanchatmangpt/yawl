# wizard.patterns Package Tutorial

**Audience**: Developers new to the wizard.patterns package
**Time**: ~15 minutes
...
- Understand the purpose of the wizard.patterns package
...
import org.yawlfoundation.yawl.integration.wizard.patterns.*;
```
