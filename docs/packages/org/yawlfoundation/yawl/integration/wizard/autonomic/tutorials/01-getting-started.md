# wizard.autonomic Package Tutorial

**Audience**: Developers new to the wizard.autonomic package
**Time**: ~15 minutes
...
- Understand the purpose of the wizard.autonomic package
...
import org.yawlfoundation.yawl.integration.wizard.autonomic.*;
```
