# integration.processmining Package Tutorial

**Audience**: Developers new to the integration.processmining package
**Time**: ~15 minutes
...
- Understand the purpose of the integration.processmining package
