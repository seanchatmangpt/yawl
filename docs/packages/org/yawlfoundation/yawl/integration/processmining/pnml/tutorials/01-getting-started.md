# processmining.pnml Package Tutorial

**Audience**: Developers new to the processmining.pnml package
**Time**: ~15 minutes
...
- Understand the purpose of the processmining.pnml package
...
import org.yawlfoundation.yawl.integration.processmining.pnml.*;
```
