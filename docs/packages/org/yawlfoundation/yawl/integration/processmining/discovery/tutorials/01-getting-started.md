# processmining.discovery Package Tutorial

**Audience**: Developers new to the processmining.discovery package
**Time**: ~15 minutes
...
- Understand the purpose of the processmining.discovery package
...
import org.yawlfoundation.yawl.integration.processmining.discovery.*;
```
