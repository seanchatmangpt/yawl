# processmining.streaming Package Tutorial

**Audience**: Developers new to the processmining.streaming package
**Time**: ~15 minutes
...
- Understand the purpose of the processmining.streaming package
...
import org.yawlfoundation.yawl.integration.processmining.streaming.*;
```
