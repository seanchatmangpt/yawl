# integration.coordination Package Tutorial

**Audience**: Developers new to the integration.coordination package
**Time**: ~15 minutes
...
- Understand the purpose of the integration.coordination package
...
import org.yawlfoundation.yawl.integration.coordination.*;
```
