# mcp.zai Package Tutorial

**Audience**: Developers new to the mcp.zai package
**Time**: ~15 minutes
...
- Understand the purpose of the mcp.zai package
...
import org.yawlfoundation.yawl.integration.mcp.zai.*;
```
