# mcp.diff Package Tutorial

**Audience**: Developers new to the mcp.diff package
**Time**: ~15 minutes
...
- Understand the purpose of the mcp.diff package
...
import org.yawlfoundation.yawl.integration.mcp.diff.*;
```
