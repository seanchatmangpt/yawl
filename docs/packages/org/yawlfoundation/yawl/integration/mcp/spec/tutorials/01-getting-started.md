# mcp.spec Package Tutorial

**Audience**: Developers new to the mcp.spec package
**Time**: ~15 minutes
...
- Understand the purpose of the mcp.spec package
...
import org.yawlfoundation.yawl.integration.mcp.spec.*;
```
