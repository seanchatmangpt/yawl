# mcp.anomaly Package Tutorial

**Audience**: Developers new to the mcp.anomaly package
**Time**: ~15 minutes
...
- Understand the purpose of the mcp.anomaly package
...
import org.yawlfoundation.yawl.integration.mcp.anomaly.*;
```
