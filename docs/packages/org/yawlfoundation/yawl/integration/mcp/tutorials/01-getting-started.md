# integration.mcp Package Tutorial

**Audience**: Developers new to the integration.mcp package
**Time**: ~15 minutes
...
- Understand the purpose of the integration.mcp package
...
import org.yawlfoundation.yawl.integration.mcp.*;
```
