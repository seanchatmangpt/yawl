# mcp.logging Package Tutorial

**Audience**: Developers new to the mcp.logging package
**Time**: ~15 minutes
...
- Understand the purpose of the mcp.logging package
...
import org.yawlfoundation.yawl.integration.mcp.logging.*;
```
