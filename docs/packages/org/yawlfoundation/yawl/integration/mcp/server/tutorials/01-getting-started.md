# mcp.server Package Tutorial

**Audience**: Developers new to the mcp.server package
**Time**: ~15 minutes
...
- Understand the purpose of the mcp.server package
...
import org.yawlfoundation.yawl.integration.mcp.server.*;
```
