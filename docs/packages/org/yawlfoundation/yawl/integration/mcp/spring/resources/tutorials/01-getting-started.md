# spring.resources Package Tutorial

**Audience**: Developers new to the spring.resources package
**Time**: ~15 minutes
...
- Understand the purpose of the spring.resources package
...
import org.yawlfoundation.yawl.integration.mcp.spring.resources.*;
```
