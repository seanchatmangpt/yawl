# mcp.spring Package Tutorial

**Audience**: Developers new to the mcp.spring package
**Time**: ~15 minutes
...
- Understand the purpose of the mcp.spring package
...
import org.yawlfoundation.yawl.integration.mcp.spring.*;
```
