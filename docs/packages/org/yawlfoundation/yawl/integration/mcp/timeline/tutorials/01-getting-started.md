# mcp.timeline Package Tutorial

**Audience**: Developers new to the mcp.timeline package
**Time**: ~15 minutes
...
- Understand the purpose of the mcp.timeline package
...
import org.yawlfoundation.yawl.integration.mcp.timeline.*;
```
