# mcp.resource Package Tutorial

**Audience**: Developers new to the mcp.resource package
**Time**: ~15 minutes
...
- Understand the purpose of the mcp.resource package
...
import org.yawlfoundation.yawl.integration.mcp.resource.*;
```
