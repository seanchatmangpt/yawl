# integration.eventsourcing Package Tutorial

**Audience**: Developers new to the integration.eventsourcing package
**Time**: ~15 minutes
...
- Understand the purpose of the integration.eventsourcing package
