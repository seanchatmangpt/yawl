# integration.test Package Tutorial

**Audience**: Developers new to the integration.test package
**Time**: ~15 minutes
...
- Understand the purpose of the integration.test package
...
import org.yawlfoundation.yawl.integration.test.*;
```
