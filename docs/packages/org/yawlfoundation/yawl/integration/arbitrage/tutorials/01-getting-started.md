# integration.arbitrage Package Tutorial

**Audience**: Developers new to the integration.arbitrage package
**Time**: ~15 minutes
...
- Understand the purpose of the integration.arbitrage package
...
import org.yawlfoundation.yawl.integration.arbitrage.*;
```
