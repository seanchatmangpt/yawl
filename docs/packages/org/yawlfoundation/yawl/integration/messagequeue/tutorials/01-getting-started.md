# integration.messagequeue Package Tutorial

**Audience**: Developers new to the integration.messagequeue package
**Time**: ~15 minutes
...
- Understand the purpose of the integration.messagequeue package
...
import org.yawlfoundation.yawl.integration.messagequeue.*;
```
