# autonomous.resilience Package Tutorial

**Audience**: Developers new to the autonomous.resilience package
**Time**: ~15 minutes
...
- Understand the purpose of the autonomous.resilience package
...
import org.yawlfoundation.yawl.integration.autonomous.resilience.*;
```
