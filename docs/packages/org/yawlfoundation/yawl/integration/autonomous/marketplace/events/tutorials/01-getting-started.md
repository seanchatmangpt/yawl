# marketplace.events Package Tutorial

**Audience**: Developers new to the marketplace.events package
**Time**: ~15 minutes
...
- Understand the purpose of the marketplace.events package
...
import org.yawlfoundation.yawl.integration.autonomous.marketplace.events.*;
```
