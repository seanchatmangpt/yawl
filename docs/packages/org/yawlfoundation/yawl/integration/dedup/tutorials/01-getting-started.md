# integration.dedup Package Tutorial

**Audience**: Developers new to the integration.dedup package
**Time**: ~15 minutes
...
- Understand the purpose of the integration.dedup package
...
import org.yawlfoundation.yawl.integration.dedup.*;
```
