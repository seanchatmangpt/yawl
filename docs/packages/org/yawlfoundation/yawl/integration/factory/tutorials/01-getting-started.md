# integration.factory Package Tutorial

**Audience**: Developers new to the integration.factory package
**Time**: ~15 minutes
...
- Understand the purpose of the integration.factory package
...
import org.yawlfoundation.yawl.integration.factory.*;
```
