# integration.adaptation Package Tutorial

**Audience**: Developers new to the integration.adaptation package
**Time**: ~15 minutes
...
- Understand the purpose of the integration.adaptation package
