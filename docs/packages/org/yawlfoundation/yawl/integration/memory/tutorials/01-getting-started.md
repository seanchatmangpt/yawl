# integration.memory Package Tutorial

**Audience**: Developers new to the integration.memory package
**Time**: ~15 minutes
...
- Understand the purpose of the integration.memory package
...
import org.yawlfoundation.yawl.integration.memory.*;
```
