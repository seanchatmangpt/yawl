# integration.immune Package Tutorial

**Audience**: Developers new to the integration.immune package
**Time**: ~15 minutes
...
- Understand the purpose of the integration.immune package
...
import org.yawlfoundation.yawl.integration.immune.*;
```
