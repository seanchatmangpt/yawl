# yawl.integration Package Tutorial

**Audience**: Developers new to the yawl.integration package
**Time**: ~15 minutes
...
- Understand the purpose of the yawl.integration package
...
import org.yawlfoundation.yawl.integration.*;
```
