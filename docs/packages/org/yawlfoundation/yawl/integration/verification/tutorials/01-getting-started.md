# integration.verification Package Tutorial

**Audience**: Developers new to the integration.verification package
**Time**: ~15 minutes
...
- Understand the purpose of the integration.verification package
...
import org.yawlfoundation.yawl.integration.verification.*;
```
