# integration.claude Package Tutorial

**Audience**: Developers new to the integration.claude package
**Time**: ~15 minutes
...
- Understand the purpose of the integration.claude package
...
import org.yawlfoundation.yawl.integration.claude.*;
```
