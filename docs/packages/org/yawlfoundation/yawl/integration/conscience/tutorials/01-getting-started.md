# integration.conscience Package Tutorial

**Audience**: Developers new to the integration.conscience package
**Time**: ~15 minutes
...
- Understand the purpose of the integration.conscience package
...
import org.yawlfoundation.yawl.integration.conscience.*;
```
