# integration.conflict Package Tutorial

**Audience**: Developers new to the integration.conflict package
**Time**: ~15 minutes
...
- Understand the purpose of the integration.conflict package
...
import org.yawlfoundation.yawl.integration.conflict.*;
```
