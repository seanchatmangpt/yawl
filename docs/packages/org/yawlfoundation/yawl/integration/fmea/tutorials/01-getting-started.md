# integration.fmea Package Tutorial

**Audience**: Developers new to the integration.fmea package
**Time**: ~15 minutes
...
- Understand the purpose of the integration.fmea package
...
import org.yawlfoundation.yawl.integration.fmea.*;
```
