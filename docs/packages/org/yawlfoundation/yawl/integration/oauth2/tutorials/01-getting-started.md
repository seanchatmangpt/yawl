# integration.oauth2 Package Tutorial

**Audience**: Developers new to the integration.oauth2 package
**Time**: ~15 minutes
...
- Understand the purpose of the integration.oauth2 package
...
import org.yawlfoundation.yawl.integration.oauth2.*;
```
