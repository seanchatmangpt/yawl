# integration.pool Package Tutorial

**Audience**: Developers new to the integration.pool package
**Time**: ~15 minutes
...
- Understand the purpose of the integration.pool package
...
import org.yawlfoundation.yawl.integration.pool.*;
```
