# procletService.blockType Package Tutorial

**Audience**: Developers new to the procletService.blockType package
**Time**: ~15 minutes
...
- Understand the purpose of the procletService.blockType package
...
import org.yawlfoundation.yawl.procletService.blockType.*;
```
