# procletService.interactionGraph Package Tutorial

**Audience**: Developers new to the procletService.interactionGraph package
**Time**: ~15 minutes
...
- Understand the purpose of the procletService.interactionGraph package
...
import org.yawlfoundation.yawl.procletService.interactionGraph.*;
```
