# editor.choiceexception Package Tutorial

**Audience**: Developers new to the editor.choiceexception package
**Time**: ~15 minutes
...
- Understand the purpose of the editor.choiceexception package
...
import org.yawlfoundation.yawl.procletService.editor.choiceexception.*;
```
