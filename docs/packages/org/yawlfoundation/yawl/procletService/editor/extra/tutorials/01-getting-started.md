# editor.extra Package Tutorial

**Audience**: Developers new to the editor.extra package
**Time**: ~15 minutes
...
- Understand the purpose of the editor.extra package
...
import org.yawlfoundation.yawl.procletService.editor.extra.*;
```
