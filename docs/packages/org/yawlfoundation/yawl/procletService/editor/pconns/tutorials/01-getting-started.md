# editor.pconns Package Tutorial

**Audience**: Developers new to the editor.pconns package
**Time**: ~15 minutes
...
- Understand the purpose of the editor.pconns package
...
import org.yawlfoundation.yawl.procletService.editor.pconns.*;
```
