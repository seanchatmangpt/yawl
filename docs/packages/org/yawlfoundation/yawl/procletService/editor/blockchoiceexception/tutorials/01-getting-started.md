# editor.blockchoiceexception Package Tutorial

**Audience**: Developers new to the editor.blockchoiceexception package
**Time**: ~15 minutes
...
- Understand the purpose of the editor.blockchoiceexception package
...
import org.yawlfoundation.yawl.procletService.editor.blockchoiceexception.*;
```
