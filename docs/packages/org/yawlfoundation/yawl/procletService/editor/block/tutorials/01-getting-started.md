# editor.block Package Tutorial

**Audience**: Developers new to the editor.block package
**Time**: ~15 minutes
...
- Understand the purpose of the editor.block package
...
import org.yawlfoundation.yawl.procletService.editor.block.*;
```
