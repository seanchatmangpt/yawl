# editor.model Package Tutorial

**Audience**: Developers new to the editor.model package
**Time**: ~15 minutes
...
- Understand the purpose of the editor.model package
...
import org.yawlfoundation.yawl.procletService.editor.model.*;
```
