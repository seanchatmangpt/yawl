# procletService.connect Package Tutorial

**Audience**: Developers new to the procletService.connect package
**Time**: ~15 minutes
...
- Understand the purpose of the procletService.connect package
...
import org.yawlfoundation.yawl.procletService.connect.*;
```
