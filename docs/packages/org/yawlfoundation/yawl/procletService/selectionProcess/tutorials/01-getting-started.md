# procletService.selectionProcess Package Tutorial

**Audience**: Developers new to the procletService.selectionProcess package
**Time**: ~15 minutes
...
- Understand the purpose of the procletService.selectionProcess package
...
import org.yawlfoundation.yawl.procletService.selectionProcess.*;
```
