# procletService.persistence Package Tutorial

**Audience**: Developers new to the procletService.persistence package
**Time**: ~15 minutes
...
- Understand the purpose of the procletService.persistence package
...
import org.yawlfoundation.yawl.procletService.persistence.*;
```
