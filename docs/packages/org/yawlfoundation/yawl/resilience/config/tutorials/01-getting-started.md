# resilience.config Package Tutorial

**Audience**: Developers new to the resilience.config package
**Time**: ~15 minutes
...
- Understand the purpose of the resilience.config package
...
import org.yawlfoundation.yawl.resilience.config.*;
```
