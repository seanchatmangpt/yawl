# resilience.autonomics Package Tutorial

**Audience**: Developers new to the resilience.autonomics package
**Time**: ~15 minutes
...
- Understand the purpose of the resilience.autonomics package
...
import org.yawlfoundation.yawl.resilience.autonomics.*;
```
