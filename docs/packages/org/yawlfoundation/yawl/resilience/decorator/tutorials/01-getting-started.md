# resilience.decorator Package Tutorial

**Audience**: Developers new to the resilience.decorator package
**Time**: ~15 minutes
...
- Understand the purpose of the resilience.decorator package
...
import org.yawlfoundation.yawl.resilience.decorator.*;
```
