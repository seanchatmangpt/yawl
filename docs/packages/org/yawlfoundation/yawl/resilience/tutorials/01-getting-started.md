# yawl.resilience Package Tutorial

**Audience**: Developers new to the yawl.resilience package
**Time**: ~15 minutes
...
- Understand the purpose of the yawl.resilience package
...
import org.yawlfoundation.yawl.resilience.*;
```
