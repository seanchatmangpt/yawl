# yawlfoundation.yawl Package Tutorial

**Audience**: Developers new to the yawlfoundation.yawl package
**Time**: ~15 minutes
...
- Understand the purpose of the yawlfoundation.yawl package
