# yawl.mailSender Package Tutorial

**Audience**: Developers new to the yawl.mailSender package
**Time**: ~15 minutes
...
- Understand the purpose of the yawl.mailSender package
...
import org.yawlfoundation.yawl.mailSender.*;
```
