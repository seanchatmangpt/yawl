...
YAWL v5.2 now includes **platform-level resilience** powered by Resilience4j. Teams get production-grade fault tolerance **by default** without writing boilerplate code.
