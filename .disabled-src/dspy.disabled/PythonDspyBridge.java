...
public final class PythonDspyBridge {
    ...
    public DspyExecutionResult execute(DspyProgram program, Map<String, Object> inputs) {
        ...
        try {
            ...
            throw new PythonException("DSPy execution failed: " + e.getMessage(), PythonException.ErrorKind.RUNTIME_ERROR, e);
        }
    }
    ...
    private String compileProgram(DspyProgram program, String cacheKey) {
        ...
        if (className == null) {
            throw new PythonException("Could not find dspy.Module class in program source", PythonException.ErrorKind.SYNTAX_ERROR);
        }
    ...
    private Map<String, Object> executeCompiledModule(String compiledModuleName, Map<String, Object> inputs) {
        ...
        if (result == null) {
            throw new PythonException("DSPy forward() returned null", PythonException.ErrorKind.RUNTIME_ERROR);
        }
