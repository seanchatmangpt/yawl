...
class RequestReplyChaos {
    ...
    void testRequestReplyNetworkChaos1MCycles() throws Exception {
        ...
        ActorRef requester = runtime.spawn(self -> {
            try {
                while (!Thread.currentThread().isInterrupted()) {
                    Object msg = self.recv();
                    if (msg instanceof Msg.Reply r) RequestReply.dispatch(r);
                }
            } catch (InterruptedException e) {
                Thread.currentThread().interrupt();
            }
        ...
        for (int i = 0; i < 1_000_000; i++) {
            ...
            CompletableFuture<Object> future = RequestReply.ask(responder, query, Duration.ofMillis(100));
    ...
    void testSystemRecoveryAfterChaos() throws Exception {
        ...
        for (int i = 0; i < 10_000; i++) {
            CompletableFuture<Object> future = RequestReply.ask(responder,
