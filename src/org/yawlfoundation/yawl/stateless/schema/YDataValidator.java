...
/**
 * Stateless-engine thin wrapper around {@link YCoreDataValidator}.
 *
 ...
 * {@link YCoreDataValidator}; this wrapper adds only the stateless-tree-specific
 * typed overloads that accept
 * {@code org.yawlfoundation.yawl.stateless.elements.data.YVariable}.
...
public class YDataValidator extends YCoreDataValidator {
    ...
    /**
     * Validates a single stateless data variable.
     *
