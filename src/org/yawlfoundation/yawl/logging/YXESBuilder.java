...
public class YXESBuilder {
    ...
    private static final DateTimeFormatter COMMENT_FORMATTER =
    ...
    protected String getComment() {
        return "Generated by the YAWL Engine " + COMMENT_FORMATTER.format(Instant.now());
    }
    ...
    private Map<String, String> parseComplexTypeDefinition(XNode typeNode) {
        Map<String, String> element2TypeMap = new HashMap<String, String>();
