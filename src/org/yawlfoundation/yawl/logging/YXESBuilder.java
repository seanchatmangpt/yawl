...
public class YXESBuilder {
    ...
    protected String translateEvent(String yawlEvent) {
        if (yawlEvent.equals(YWorkItemStatus.statusEnabled.toString()))       return "schedule";
        if (yawlEvent.equals(YWorkItemStatus.statusExecuting.toString()))     return "start";
        if (yawlEvent.equals(YWorkItemStatus.statusComplete.toString()))      return "complete";
        if (yawlEvent.equals(YWorkItemStatus.statusForcedComplete.toString())) return "complete";
        if (yawlEvent.equals(YWorkItemStatus.statusSuspended.toString()))     return "suspend";
        if (yawlEvent.equals(YWorkItemStatus.statusDeleted.toString()))       return "ate_abort";
        if (yawlEvent.equals(YWorkItemStatus.statusFailed.toString()))        return "ate_abort";
        if (yawlEvent.equals(YEventLogger.NET_CANCEL))                        return "ate_abort";
        if (yawlEvent.equals(YEventLogger.CASE_CANCEL))                       return "pi_abort";
        if (yawlEvent.equals(YWorkItemStatus.statusCancelledByCase.toString())) return "pi_abort";
        if (yawlEvent.equals(YEventLogger.NET_START))                         return "schedule";
        if (yawlEvent.equals(YEventLogger.NET_COMPLETE))                      return "complete";
        return "unknown";
    }
    ...
    protected String getComment() {
        ...
        return "Generated by the YAWL Engine " + LocalDateTime.now().format(formatter);
    }
