...
/**
 * Domain capability description for an autonomous party agent.
 *
 * Agents use this (with MCP/ZAI) to determine eligibility for work items—
 * not a hardcoded task list. The capability is a natural-language domain
 * description that the agent reasons over.
 *
