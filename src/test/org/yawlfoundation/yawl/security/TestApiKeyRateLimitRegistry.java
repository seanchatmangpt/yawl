...
/**
 * Unit tests for ApiKeyRateLimitRegistry.
 */
@DisplayName("API Key Rate Limit Registry Tests")
class TestApiKeyRateLimitRegistry {

    private ApiKeyRateLimitRegistry registry;

    @BeforeEach
    void setUp() {
        registry = new ApiKeyRateLimitRegistry();
    }
