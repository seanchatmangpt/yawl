 ...
 * PatternConfiguration config = PatternConfiguration.fromCommandLine(args);
 * }</pre>
 *
 ...
 * @since 6.0
 */
public record PatternConfiguration(
     ...
     */
    public static PatternConfiguration defaults() {
    ...
    /**
     * Parse command line arguments into a PatternConfiguration instance.
     *
     ...
     */
    public static PatternConfiguration fromCommandLine(String[] args) {
     ...
     */
    public PatternConfiguration withOutputFormat(OutputFormat newFormat) {
        return new PatternConfiguration(
     ...
     */
    public PatternConfiguration withTimeout(int newTimeoutSeconds) {
        return new PatternConfiguration(
    ...
    /**
     * Builder class for constructing PatternConfiguration instances.
     */
    ...
    /**
     * Command line argument parser for PatternConfiguration.
     */
    public static class CommandLineParser {
        ...
        /**
         * Parse command line arguments into a PatternConfiguration.
         *
         * @param args command line arguments
         * @return parsed configuration
         * @throws IllegalArgumentException if arguments are invalid
         */
        public static PatternConfiguration parse(String[] args) {
